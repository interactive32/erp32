<form action="index.php" {if $targetframe!=""}target="{$targetframe}"{/if}>
...
<table cellpadding="0" cellspacing="0" height="18">
  <tr>
    <td valign="center"><input id='top-search-input' maxlength=88 name="searchstring" type="text" size="18" value="{$searchstring}">&nbsp;</td>
